  ...
  return (
    ...
    <div className="flex flex-col items-center gap-8 px-8 mt-12 ">
     ...
     <div className="grid grid-cols-2 items-center">
      <div>
      <h1 className="font-semibold lg:text-4xl mb-8  ">Apex Learning Courses</h1>
    ...
    <Image src="/Picture211.png" alt="ai1" width={600} height={600} className="col-span-1 "  />
     ...
     <div className="grid grid-cols-2 items-center">
      <div>
      <h1 className="font-semibold text-3xl mb-8 lg:text-4xl ">Ministry of Education Approval for Excellence</h1>
    ...
    <Image src="/Picture31.png" alt="ai1" width={400} height={400} className="col-span-1 "  />
     ...
     <div className="w-4/6 flex flex-col">
      <h1 className="font-semibold text-3xl mb-8 lg:text-4xl  ">Our Evidence—your Impact</h1>
    ...
    <Image src="/Picture41.png" alt="ai1" width={450} height={500} className="col-span-1 "  />
      ...
      <div>
      <h1 className="font-semibold text-3xl mb-8 lg:text-4xl">Rigorous and Mastery-Based Instruction</h1>
      ...
      <div className="px-8">
      <h1 className="font-semibold text-3xl mb-8  mt-4 w-fit shadow-md shadow-primary px-4 py-2">Instruct with proven pedagogical design</h1>
      ...
      <h1 className="font-semibold text-3xl mb-8  border-primary w-fit shadow-md shadow-primary px-4 py-2">	Support students when they need it most</h1>
      ...
      <h1 className="font-semibold text-3xl mb-8  mt-4  w-fit shadow-md shadow-primary px-4 py-2">Gain insights into pacing and progress</h1>
      ...
      <h1 className="font-semibold text-3xl mb-8  w-fit shadow-md shadow-primary px-4 py-2  mt-4">Prioritize academic integrity</h1>
    ...
    <Image src="/apex.png" alt="ai1" width={700} height={350} className="col-span-1 "  />
      ...
      <div>
      <h1 className="font-semibold text-3xl mb-8 lg:text-4xl ">Empowering Parents with Weekly Progress Reports</h1>
     ...
     <div className="grid grid-cols-2 items-center">
      <div>
      <h1 className="font-semibold text-3xl mb-8 lg:text-4xl ">Success without Boundaries</h1>
