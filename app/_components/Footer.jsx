...
const Footer = () => {
  ...
  <div className=" bg-[#064C77] text-white px-12 pb-2 pt-8 mt-8 ">
    ...
    <div
      ...
      <div className="">
        <p className="text-2xl font-semibold ">Academics</p>
      ...
      <div className="">
        <p className="text-2xl font-semibold "> Online Learning</p>
        ...
        <ul className="flex flex-col gap-4 mt-8">
          ...
          <Link  className=" transition hov" href="/">
      ...
      <div className="">
        <p className="text-2xl font-semibold">Enrolment</p>
